...
<Callout type="info">
When deploying with `pactkit init --format opencode`, the project-level `opencode.json` is pre-configured with Context7 as a remote MCP. Add other servers manually as needed.
</Callout>
