...
6. **Context** — update `docs/product/context.md` for cross-session awareness
...
3. **Implement** — write code to make tests pass (GREEN), with a 5-iteration cap
...
11. **Context** — update `docs/product/context.md` for next session
